...
@Autonomous(name = "BLUEFAR TRUSS (3)", group = "auto", preselectTeleOp = "TerraOp")
public class BLUE_FAR_STACK_THREE_TRUSS extends AutoFramework {
...
//            outtake.stageStackRotate(.1)
    ...
    public void define() {
        ...
        customCase(() -> {
            ...
            addTimedSetpoint(1.0,.5,1,5,-50,0);
            ...
            addTimedSetpoint(1,.8,1,200,-50 ,-100);
            addAutoModule(align);
