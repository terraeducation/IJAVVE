...
//        voltageScale = 1;
//
//        OUTTAKE_OLD.setToTeleop();
//        OUTTAKE_OLD.changeArmPosition("endHalf", 0.74);
//        OUTTAKE_OLD.changeArmPosition("start", 0.0);
...
//         * Gamepad 2 Manual
//         */
//        gph2.link(RIGHT_BUMPER, OUTTAKE_OLD::closeClaw);
//        gph2.link(LEFT_BUMPER, OUTTAKE_OLD::openClawHalf);
